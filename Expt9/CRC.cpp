...
int main()
{
	...
	cout << "\n" << msg;
	for( char i : msg.substr(msg.length() - crc.length() + 1))	//after performing xor , if the last few bits are zero then there's no error in transmission
		if( i != '0' )
			{	
